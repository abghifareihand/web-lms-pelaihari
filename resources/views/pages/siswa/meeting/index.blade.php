        ...
        @forelse ($meetings as $meeting)
                    ...
                    <div class="card-body p-24">
                        ...
                        <div class="w-100 radius-8 overflow-hidden d-block bg-light d-flex flex-column align-items-center justify-content-center text-center"
                            ...
                            <div
                                ...
                                {{ \Carbon\Carbon::parse($meeting->schedule_at)->translatedFormat('d M, Y • H:i') }}
                            </div>
                        ...
                        <div class="mt-20">
                            ...
                            <div class="d-flex align-items-center gap-6 justify-content-between flex-wrap mb-16">
                                <span
                                    ...
                                    {{ $meeting->creator->role === 'admin' ? 'text-primary-600 bg-primary-100' : ($meeting->creator->role === 'guru' ? 'text-lilac-600 bg-lilac-100' : 'text-neutral-600 bg-neutral-100') }}
                                ...
                                <div class="d-flex align-items-center gap-8 text-neutral-500 fw-medium text-xs">
                                    <i class="ri-calendar-2-line"></i>
                                    {{ \Carbon\Carbon::parse($meeting->created_at)->translatedFormat('d M, Y H:i') }}
                                </div>
                            ...
                            {{-- Title --}}
                            <h6 class="mb-16">
                                <a href="{{ route('siswa.materi.show', $meeting->id) }}"
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-6">
                                <div class="d-flex align-items-center gap-8">
                                    ...
                                    <div class="d-flex flex-column">
                                        <h6 class="text-xs mb-0 fw-semibold">{{ $meeting->creator->name ?? '-' }}</h6>
                                        <span
                                            class="text-xxs text-neutral-500">{{ \Carbon\Carbon::parse($meeting->created_at)->diffForHumans() }}</span>
                                    </div>
                                </div>
                                <a href="{{ route('siswa.meeting.show', $meeting->id) }}"
            ...
            @empty
                <div class="col-12 text-center py-20 text-gray-500">
                    Belum ada meeting yang tersedia.
                </div>
            @endforelse
        </div>
