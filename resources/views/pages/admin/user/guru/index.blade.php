        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                    ...
                    <a href="{{ route('admin.user.guru.create') }}" class="btn btn-primary"><i class="ri-add-line"></i>Tambah
                        Guru</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @forelse ($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            <span
                                                class="badge text-sm fw-semibold text-info-600 bg-info-100 px-20 py-9 radius-4 text-white text-uppercase">
                                                {{ $user->role }}
                                            </span>
                                        </td>
                                        ...
                                        <td class="d-flex justify-content-center gap-2">
                                            {{-- Edit --}}
                                            <a href="{{ route('admin.user.guru.edit', $user->id) }}"
                                                class="w-32-px h-32-px bg-success-focus text-success-main rounded-circle d-inline-flex align-items-center justify-content-center">
                                                <iconify-icon icon="lucide:edit"></iconify-icon>
                                            </a>

                                            {{-- Delete --}}
                                            <form action="{{ route('admin.user.guru.destroy', $user->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
