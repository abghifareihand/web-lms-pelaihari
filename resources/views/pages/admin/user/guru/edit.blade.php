        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                    ...
                    <a href="{{ route('admin.user.guru.index') }}" class="btn btn-secondary">
                        <i class="ri-arrow-left-line"></i> Kembali
                    </a>
                </div>
                <div class="card-body">
                    <form class="row gy-3" action="{{ route('admin.user.guru.update', $user->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        {{-- Password Guru --}}
                        <div class="col-12">
                            <label class="form-label">Password <small class="text-muted fw-normal">(Kosongkan jika tidak ingin diubah)</small></label>
                        ...
                        <div class="col-12 d-flex justify-content-end">
                            <button class="btn btn-primary" type="submit">
                                <i class="ri-save-line me-2"></i> Update Guru
                            </button>
                        </div>
                    </form>
                </div>
