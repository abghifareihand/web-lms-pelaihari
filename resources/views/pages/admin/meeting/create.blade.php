        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                    <h5 class="card-title mb-0">Tambah Meeting</h5>
                    <a href="{{ route('admin.meeting.index') }}" class="btn btn-secondary">
                        <i class="ri-arrow-left-line"></i> Kembali
                    </a>
                </div>
                <div class="card-body">
                    <form class="row gy-3" action="{{ route('admin.meeting.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="col-12">
                            ...
                            <input type="datetime-local" name="schedule_at" class="form-control" @error('schedule_at') is-invalid @enderror"
                        ...
                        <div class="col-12 d-flex justify-content-end">
                            <button class="btn btn-primary" type="submit">
                                <i class="ri-save-line me-2"></i> Simpan Meeting
                            </button>
                        </div>
                    </form>
                </div>
