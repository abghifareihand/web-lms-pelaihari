        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-3">
                    ...
                    <a href="{{ route('guru.blog.create') }}" class="btn btn-primary"><i class="ri-add-line"></i>Tambah
                        Blog</a>
                </div>
                <div class="card-body">
                                ...
                                @forelse ($blogs as $blog)
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center gap-2">
                                            {{-- Show --}}
                                            <a href="{{ route('guru.blog.show', $blog->id) }}"
                                            ...
                                            {{-- Edit --}}
                                            <a href="{{ route('guru.blog.edit', $blog->id) }}"
                                                class="w-32-px h-32-px bg-success-focus text-success-main rounded-circle d-inline-flex align-items-center justify-content-center">
                                                <iconify-icon icon="lucide:edit"></iconify-icon>
                                            </a>

                                            {{-- Delete --}}
                                            <form action="{{ route('guru.blog.destroy', $blog->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
