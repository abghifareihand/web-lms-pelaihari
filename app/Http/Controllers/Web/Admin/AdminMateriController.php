...
class AdminMateriController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.admin.materi.index', compact('materis'));
    }
    ...
    public function create()
    {
        ...
        $admin = Auth::id();
        return view('pages.admin.materi.create', compact('teachers', 'admin'));
    }
    ...
    {
        return view('pages.admin.materi.show', compact('materi'));
    }
    ...
    public function edit(Materi $materi)
    {
        $teachers = User::where('role', 'guru')->get();
        $admin = Auth::id();
        return view('pages.admin.materi.edit', compact('materi', 'teachers', 'admin'));
    }
